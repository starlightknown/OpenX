...
# 1. Introduction
**Welcome!** Thank you for contributing to the further development of OpenX. We're always looking for new ways to improve our project and we appreciate any help you can give us.
...
* Add a upstream link to main branch in your cloned repo
    ```
    git remote add upstream https://github.com/starlightknown/OpenX
    ```
